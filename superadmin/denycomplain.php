...
{
   if(denyComplain($conn,$_POST))
   {
   showSuccessMsg('Complain rejected Successfully !!!');
...
<?php include 'layouts/sidebar2.php';?>
 ...
 <div class="main-content">
    ...
    $('#addForm').submit(function(){
        ...
        if(!validateText($('#comp_status').val(),'admin_status')
            ||!validateText($('#comp_remark').val(),'comp_remark'))
        {
            return false;
        }
        else
